...
// //   const BACKEND_URL = "http://10.147.147.52:5000/api/details"; // replace with your backend URL
...
// //     try {
// //       const response = await fetch(`${BACKEND_URL}?receiverName=${searchQuery}`);
// //       const data = await response.json();

// //       if (response.ok) {
// //         setResults(data);
// //       } else {
// //         Alert.alert("Error", data.message || "No records found");
// //       }
// //     } catch (error) {
...
// //       <Text style={styles.title}>Search Goods by Receiver</Text>
...
// //             <Text style={styles.cardText}>📦 {item.goodsName} ({item.quantity})</Text>
// //             <Text style={styles.cardText}>🚚 {item.transportName} ({item.transportNumber})</Text>
// //             <Text style={styles.cardText}>🎯 {item.receiverName} ({item.receiverNumber})</Text>
...
//   const BACKEND_URL = "http://10.147.147.52:5000/api/details"; // your backend
...
//   return (
//     <View style={styles.container}>
//       <Text style={styles.title}>Search by Receiver Name</Text>
...
//   button: { flex: 1, padding: 12, borderRadius: 8, alignItems: "center", backgroundColor: "#007bff", marginHorizontal: 5 },
//   buttonText: { color: "#fff", fontSize: 16, fontWeight: "bold" },
//   card: { backgroundColor: "#fff", padding: 12, borderRadius: 10, marginBottom: 10, elevation: 2 },
//   cardTitle: { fontSize: 16, fontWeight: "bold", marginBottom: 5 },
//   cardText: { fontSize: 14, marginBottom: 4 },
